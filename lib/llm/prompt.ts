...
19. 【理解補助セクション — 画像キャプション (imageCaption)】メイン画像は imagePrompt から生成される匿名的なイメージ写真です。その写真に写る対象と記事との関係だけを、40〜90字程度の日本語1文で説明してください。写真から確認できない具体的事実(企業名・人名・日付・数値)や記事内容の解説を過剰に含めないでください。適切なキャプションが書けない場合は null を返してください。
...

{
  ...
  "imageCaption": "画像キャプション(40〜90字程度の1文。書けなければnull)",
