...
D. 文章品質
  ...
  - 画像キャプションが「AI生成イメージ」「実在の施設を示す写真ではない」など生成画像であることを明示するのは透明性のための適切な表示であり、制作痕跡やメタ注釈として問題にしない
...
- imageCaption は許容境界ぎりぎりを避け、50〜80字程度の日本語1文にしてください。適切に書けなければ null にしてください。
