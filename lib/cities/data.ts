  ...
  },
  {
    ...
    specialties: [
      ...
      },
      {
        ...
        kind: "祭事",
        note: "1927年設立のマドラス・ミュージック・アカデミーを起点に始まった、カルナーティック音楽と古典舞踊の祭典。11月中旬〜1月にかけて市内各所の「サバー」で公演が行われ、2004〜05年シーズンには約20のサバーで約600人の演者による1,200件超の演目が上演された。",
      },
    ],
    living: {
      housing: {
      ...
      safetyHealth: {
        safetyNote: "インドの大都市の中では比較的治安が安定しているとされるが、市場や公共交通機関でのスリに注意が必要。北チェンナイのロヤプラム(Royapuram)・ワシャーマンペット(Washermanpet)・ヴィヤーサルパーディ(Vyasarpadi)・ペランブール(Perambur)一帯は夜間の単独行動を避けたい。ジョージタウンのパリーズ・コーナーやバーマ・バザールなど混雑した市場でもスリ・置き引きに注意し、夜間の移動はUber・Olaなどアプリ配車の利用が推奨される。",
        hospitals: [
          {
