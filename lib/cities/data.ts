  ...
  },
  {
    ...
    living: {
      housing: {
        ...
        note: "Koregaon Park・Kalyani Nagarはプネ空港から車で20〜35分と近く、カフェやレストランが集まる駐在員に人気のエリア。自動車・重工業の集積地チャカン(Chakan MIDC)までは車で30〜40分程度で、同工業団地に勤務する駐在員もこの一帯に居住して通勤するケースが多い。",
      },
      safetyHealth: {
        safetyNote: "Koregaon Park・Kalyani Nagar一帯はプネの中でも治安が安定しているとされるが、混雑した市場や公共交通機関でのスリ・置き引きには注意が必要。夜間の移動はUber・Olaなどアプリ配車の利用が推奨される。",
        hospitals: [
          {
          ...
          },
          {
            ...
            note: "1946年開業、350床。2013年にNABH認定を取得し、中東・アフリカなどからの外国人患者向けに専用窓口を備える。",
          },
        ],
        healthNote: "いずれの病院も日本語対応スタッフが常駐しているとの確証は得られなかった。英語での症状説明に不安がある場合は、海外旅行保険の医療アシスタンスサービス経由で通訳付き受診を手配するのが安全。",
      },
      transport: {
        ...
        inCity: "プネメトロのパープルライン(PCMCバワン〜スワルゲート、17.4km・12駅)とアクアライン(ヴァナズ〜ラームワディ、15.7km・16駅)が2022年3月に開業し運行中(2025年12月時点で合計約33km・28駅)。Uber・Olaなどアプリ配車も広く普及しているが、道路渋滞が慢性的。",
        directFlightFromJapan: "プネ発着の日本直行便はなく、羽田・成田からはデリー・ムンバイ・ベンガルールなどでANA/JAL/エア・インディア便から国内線に乗り継ぐのが一般的。ムンバイ(CSMIA)からプネ市内へは陸路で約150km、ムンバイ・プネ高速道路(ヤシュワントラオ・チャヴァン高速道路)経由で好条件下なら2〜2.5時間だが、金曜・日曜夕方は渋滞が集中し3時間超かかることも多く、モンスーン期(6〜9月)はさらに30〜45分の遅れを見込みたい。",
