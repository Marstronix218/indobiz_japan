  ...
  },
  {
    ...
    specialties: [
      ...
      },
      {
        jp: "バルチャリ・サリー",
        kind: "土産",
        note: "18世紀にムルシダーバード近郊の織物村バルチャルで始まった、物語柄の裾模様(パッルー)が特徴の絹サリー。飢饉・洪水による衰退を経て、20世紀前半にビシュヌプルの織元アクシャイ・クマール・ダスがジャカード織技法で再興し、現在は同地の特産として2011年にGI登録されている。",
      },
    ],
    living: {
      housing: {
        ...
        hospitals: [
          {
            ...
            note: "2003年開業、Apolloグループとシンガポールのパークウェイ・ヘルスの合弁で設立された700床の総合病院。東インドで唯一JCI(国際病院評価機構)認定を取得しており、NABH認定も持つ。",
          },
          {
      ...
      transport: {
        ...
        commuteNote: "2025年9月23日未明には記録的な豪雨(市内の一部地点で3時間程度に300mm超、24時間で最大332mm)によりコルカタ市内が広範囲に冠水し、1988年以来最も激しい降雨とされた。感電などで市内だけで9人が死亡し、バンドロニ・ジャドブプルなど南部・東部の一部地域では冠水が3日間続いた。6〜9月の本格的なモンスーン期の出張・引っ越し日程には余裕を持たせたい。",
      },
      japaneseCommunity: {
        association: "Japan Club Kolkata（在コルカタ日本人会）",
        schools: [],
        groceries: [],
        corporateNote: "コルカタは日印交流の歴史が深く、1901〜02年に岡倉天心がタゴール家に滞在してラビンドラナート・タゴールと親交を結び、ベンガル派の画家たちに日本画の技法を伝えたことでも知られる。現在はJapan Club Kolkataが在留邦人の交流拠点となっており、在コルカタ総領事公邸での餅つき会などの行事を開催している。西ベンガル州内の日系製造拠点としては、タタ・モーターズ40%／日立建機60%出資のタタ日立建設機械カラグプル工場(コルカタから西へ約120km、2009年稼働)がある。JETROの単独事務所はなく(インド国内の拠点はニューデリー・ムンバイ・ベンガルール・チェンナイ・アーメダバードの5カ所)、経済関連の相談は在コルカタ日本国総領事館が窓口となる。",
      },
      verifiedAt: "2026-07",
    },
  },
