...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    living: {
      ...
      safetyHealth: {
        ...
        hospitals: [
          ...
          },
          {
            ...
            note: "2006年開業、JCI(国際病院評価機構)・NABH認定を取得した総合病院。",
          },
          {
            name: "Apollo Hospitals（バンネルガッタ・ロード）",
            note: "2007年開業、JCI・NABH認定を取得した350床の総合病院。50以上の診療科を持つ。",
          },
        ],
      ...
      transport: {
        fromAirport: "KIA(ケンペゴウダ国際空港)は市中心部から北へ離れたデヴァナハッリ地区にあり、Indiranagar・Whitefieldいずれへの所要時間も渋滞状況により大きく変動する。",
        inCity: "地下鉄Namma Metroが拡大中で、パープルラインはWhitefieldからChallaghattaまでを結ぶ。Uber・Olaなどアプリ配車も広く普及しているが、道路渋滞が慢性的。",
        directFlightFromJapan: "JAL(日本航空)が成田―ベンガルール間に直行便(JL753/754便)を運航している。ANAの直行便はない。",
        commuteNote: "TomTomトラフィック指数2025によれば、ベンガルールは世界で2番目に渋滞の激しい都市(渋滞スコア74.4)。平均時速16.6km/hで、通勤者はラッシュ時の渋滞により年間168時間を失う計算となる。オフィスと居住地の距離をできるだけ縮めることが、他都市以上に重要な判断材料となる。",
      },
      japaneseCommunity: {
        association: "バンガロール日本人会（bangalore-nihonjinkai.com）",
        schools: ["バンガロール補習授業校（土曜校、Trio World Academy内・Sahakar Nagar）"],
        groceries: [],
        corporateNote: "ベンガルールはPune・Hyderabad・Noida・Gurgaon・Chennai・Navi Mumbaiと並ぶインドのGCC(グローバル・キャパビリティ・センター)集積都市の一つ。",
      },
      verifiedAt: "2026-07",
    },
  },
    ...
    living: {
      housing: {
        areas: [
          "Adyar",
          "Besant Nagar",
          "OMR（Old Mahabalipuram Road、IT・自動車部品企業回廊）",
        ],
        rents: [
          {
            layout: "2BHK（Adyar・Besant Nagar、駐在員向け）",
            minUsd: 260,
            maxUsd: 520,
          },
          {
            layout: "2BHK（OMR・Sholinganallur、駐在員向け）",
            minUsd: 260,
            maxUsd: 630,
          },
        ],
        note: "Adyar・Besant Nagarはベイ・オブ・ベンガル沿いの南チェンナイに位置する閑静な高級住宅地で、駐在員家庭に選ばれやすい。OMR（IT回廊）は北のオラガダム・スリペルンブドゥール自動車工業団地への通勤にも便利で、自動車関連の駐在員が住むケースもある。チェンナイ補習授業校はタラマニのAmerican International School Chennai内にあり、いずれのエリアからもアクセス可能な立地。",
      },
      safetyHealth: {
        safetyNote: "インドの大都市の中では比較的治安が安定しているとされるが、市場や公共交通機関でのスリに注意が必要。北チェンナイのロヤプラム(Royapuram)・ワシャーマンペット(Washermanpet)・ヴィヤーサルパーディ(Vyasarpadi)一帯は夜間の単独行動を避けたい。ジョージタウンのパリーズ・コーナーやバーマ・バザールなど混雑した市場でもスリ・置き引きに注意し、夜間の移動はUber・Olaなどアプリ配車の利用が推奨される。",
        hospitals: [
          {
            name: "Apollo Hospitals（グリームズ・ロード）",
            note: "1983年開業のApolloグループ旗艦病院で、インド初の民間総合病院として知られる。2006年からJCI(国際病院評価機構)認定を継続取得し、2024年3月に7回目の再認定を受けた。国際患者向けに通訳手配・ビザ支援などの窓口を備える。",
          },
          {
            name: "MIOT International（マナパッカム）",
            note: "1999年2月開業。年間約3,500人(全患者の約25%)の外国人患者を受け入れており、空港送迎の無料手配など国際患者向け支援体制を備える。NABH・NABL認定を取得。",
          },
          {
            name: "Gleneagles Global Health City（ペルンバッカム）",
            note: "2008年開業、21エーカーの敷地を持つ大規模病院。JCI・NABH・NABL認定を取得し、国際患者向けに通訳手配などの窓口を備える。",
          },
        ],
        healthNote: "いずれの病院も日本語対応スタッフが常駐しているとの確証は得られなかった。英語での症状説明に不安がある場合は、海外旅行保険の医療アシスタンスサービス経由で通訳付き受診を手配するのが安全。",
      },
      transport: {
        fromAirport: "チェンナイ国際空港(MAA)からAdyarまで車で約15〜35分、Besant Nagarまで約15〜20分、OMR・ショーリンガンナルルまで渋滞状況により約45〜60分。空港は2026年11月末の完了を目標に第3ターミナルを含む拡張工事(フェーズII)が進行中で、出張時期によっては構内の混雑・動線変更が生じる可能性がある。",
        inCity: "チェンナイ・メトロが基幹交通で、ブルーライン(空港〜ウィムコナガル、32.65km・26駅)とグリーンライン(チェンナイ・セントラル〜セント・トーマス・マウント、22km・17駅)が運行中(2025年12月時点で総延長54.1km)。Uber・Olaなどアプリ配車も広く普及している。",
        directFlightFromJapan: "チェンナイ発着の日本direct便はなく(2026年時点で運航社数0)、羽田・成田からの渡航にはデリー・ムンバイ・ベンガルールでANA/JAL便から国内線に乗り継ぐか、シンガポール・バンコク・香港など第三国ハブ経由での乗り継ぎが一般的。",
        commuteNote: "北東モンスーン期(10〜12月)は集中豪雨による道路冠水・交通混乱のリスクが高まる。2015年11〜12月にはタミル・ナードゥ州で大規模な洪水が発生し、州政府の最終集計(2016年1月)では10月28日〜12月31日の期間に421人が死亡した。この年の11月の月間降水量は1,049mmで1918年11月(1,088mm)以来の記録的な多さだった。この時期の出張・引っ越し日程には余裕を持たせたい。",
      },
      japaneseCommunity: {
        association: "チェンナイ日本人会（chennai-nihonjinkai.com）",
        schools: [
          "チェンナイ補習授業校（Chennai Hoshuko、American International School Chennai内・タラマニ）",
        ],
        groceries: [],
        corporateNote: "チェンナイはルノー・日産アライアンスにとって世界初の専用生産拠点となったオラガダム工場(2008年設立、敷地600エーカー)を擁し、2010年から生産を開始した。同工場は2025年8月にルノーが日産保有分51%を追加取得して完全子会社化したが、日産車の生産は引き続き行われている。ヤマハもチェンナイ近郊ヴァラム・ヴァダガルに3番目のインド工場を2015年に開設した。60kmに及ぶ自動車回廊全体ではインドの四輪車生産の約30%、自動車部品生産の約35%を占めるとされ、JETROもアンナ・サライにチェンナイ事務所を置き日系企業の進出を支援している。チェンナイ補習授業校は2025年度に開校50周年を迎えており、自動車集積を背景とした日本人コミュニティの厚みを裏付ける。",
      },
      verifiedAt: "2026-07",
    },
  },
  {
    ...
    living: {
      housing: {
        ...
        rents: [
          {
            layout: "2BHK（Koregaon Park、駐在員向け）",
            minUsd: 300,
            maxUsd: 650,
          },
          {
            layout: "2BHK（Kalyani Nagar、駐在員向け）",
            minUsd: 300,
            maxUsd: 550,
          },
        ],
        note: "Koregaon Park・Kalyani Nagarはプネ空港から車で20〜35分と近く、カフェやレストランが集まる駐在員に人気のエリア。自動車・重工業の集積地チャカン(Chakan MIDC)までは車で30〜40分程度。",
      },
      safetyHealth: {
        safetyNote: "Koregaon Park・Kalyani Nagar一帯はプネの中でも治安が安定した住宅地だが、混雑した市場や公共交通機関でのスリ・置き引きには注意が必要。夜間の移動はUber・Olaなどアプリ配車の利用が推奨される。",
        hospitals: [
          {
            name: "Noble Hospitals and Research Centre（ハダプサル）",
            note: "2023年11月にJCI(国際病院評価機構)認定を取得。プネの三次医療機関としては初、マハーラーシュトラ州では10番目のJCI認定病院。",
          },
          {
            name: "Ruby Hall Clinic（サッスーン・ロード）",
            note: "1959年に4床の診療所として開業し、現在は約600床規模。NABH・NABL認定を持ち、渡航・宿泊手配を含む国際患者向けサービスを提供する。",
          },
          {
            name: "Jehangir Hospital（サッスーン・ロード）",
            note: "1946年開業、350床。2013年にNABH認定を取得し、外国人患者向けの専用ヘルプデスク(国際患者サービス)を備える。",
          },
        ],
        healthNote: "いずれの病院も日本語対応スタッフが常駐しているとの確証は得られなかった。英語での症状説明に不安がある場合は、海外旅行保険の医療アシスタンスサービス経由で通訳付き受診を手配するのが安全。",
      },
      transport: {
        fromAirport: "プネ空港(PNQ、ローヘガーオン)からKoregaon Parkまで車で約20〜30分、Kalyani Nagarまで約25〜35分。",
        inCity: "プネメトロのパープルライン(PCMCバワン〜スワルゲート、17.4km・14駅)とアクアライン(ヴァナズ〜ラームワディ、15.7km・16駅)が2022年3月に開業し運行中(2025年12月時点で合計約33km・28駅)。Uber・Olaなどアプリ配車も広く普及しているが、道路渋滞が慢性的。",
        directFlightFromJapan: "プネ発着の日本直行便はなく、羽田・成田からはデリー・ムンバイ・ベンガルールなどでANA/JAL/エア・インディア便から国内線に乗り継ぐのが一般的。ムンバイ(CSMIA)からプネ市内へは陸路で約150km、ムンバイ・プネ高速道路(ヤシュワントラオ・チャヴァン高速道路)経由で好条件下なら2〜2.5時間だが、金曜・日曜夕方は渋滞が集中し3時間超かかることも多く、モンスーン期(6〜9月)は土砂崩れによる通行止めや大幅な遅延が発生することもあり、所要時間に十分な余裕を持たせたい。",
        commuteNote: "モンスーン期(6〜9月)はプネ市警察が指定する市内26カ所の冠水多発地点を中心に、豪雨のたびに道路冠水・渋滞が発生しやすい。自動車工業団地が集まるチャカン(Chakan MIDC)までは市中心部から車で約30〜40分だが、渋滞時はさらに延びるため出張・通勤日程には余裕を持たせたい。",
      },
      japaneseCommunity: {
        association: "プネ日本人会（punejapan.com、2025年12月にpune-japan.comから移転）",
        schools: [],
        groceries: [],
        corporateNote: "自動車工業団地チャカン(Chakan MIDC)にはブリヂストンが2013年開業のタイヤ工場を構え、日立アステモもチャカンおよび市内シヴァージーナガルにオフィスを置く。工作機械ではヤマザキマザックが2023年3月からプネ近郊ランジャンガーオン工業団地の新工場で国内市場向け立形マシニングセンタの生産を開始した。プネ日本人会の理事会企業には川崎重工グループのインドカワサキモータース、矢崎(Yazaki India)、エンケイホイールズ、JFE商事スチールインディア、三菱電機インディア、ニプロインディアなど自動車・部品・素材の幅広い日系企業が名を連ねており、重工業ベルトとしての日系企業集積の厚みを裏付ける。",
      },
      verifiedAt: "2026-07",
    },
  },
  {
    ...
    living: {
      housing: {
        areas: ["Gachibowli", "Jubilee Hills"],
        rents: [
          {
            layout: "2BHK（Gachibowli、駐在員向け）",
            minUsd: 260,
            maxUsd: 630,
          },
          {
            layout: "2BHK（Jubilee Hills、駐在員向け）",
            minUsd: 280,
            maxUsd: 580,
          },
        ],
        note: "GachibowliはHITECシティに隣接するIT・GCC企業の集積地で、Microsoft・Amazon・Accentureなど外資系オフィスに近い。Jubilee Hillsは飲食店やブティックが集まる高級住宅・商業エリアで、駐在員に選ばれやすい。",
      },
      safetyHealth: {
        safetyNote: "Jubilee Hills・Banjara Hills・Gachibowli・Kondapur・Madhapurなど新市街のゲーテッドコミュニティ周辺は治安が比較的安定している。チャルミナール周辺の旧市街(オールドシティ)は昼間の観光は問題ないが、道幅が狭く人混みが激しいため夜間はスリや雑踏事故に注意したい。深夜の移動はUber・Olaなどアプリ配車の利用が推奨される。",
        hospitals: [
          {
            name: "Apollo Hospitals（ジュビリーヒルズ）",
            note: "1988年開業、550床のクアタナリーケア病院。JCI・NABH・NABL認定を取得し、2024年3月に7回目のJCI再認証を受けた。インド国内外からの紹介患者を受け入れる国際患者サービスを備える。",
          },
          {
            name: "Yashoda Hospitals（ソマジグダ・セカンダラーバード・マラクペット・ヒテックシティ）",
            note: "1989年にラオ兄弟が創業した病院グループで、市内4拠点を展開。JCI・NABH・NABL認定を取得し、ビザ・宿泊手配や通訳を含む国際患者サービスチームを備える。",
          },
          {
            name: "KIMS Hospitals（セカンダラーバード）",
            note: "2004年開業、約1,000床の旗艦病院。NABH認定・AACI(米国国際認定委員会)認定を取得し、国際患者向けの専用窓口を備える。",
          },
        ],
        healthNote: "いずれの病院も国際患者向け窓口を備えるが、日本語対応スタッフが常駐しているとの確証は得られなかった。英語での症状説明に不安がある場合は、海外旅行保険の医療アシスタンスサービス経由で通訳付き受診を手配するのが安全。",
      },
      transport: {
        fromAirport: "RGIA(ラジーブ・ガンディー国際空港、シャムシャバード)からGachibowliまで車で約35〜45分、Jubilee Hillsまで約35分、Banjara Hillsまで約30〜35分(渋滞状況により変動)。",
        inCity: "ハイデラバード・メトロ(レッド・ブルー・グリーンの3路線、総延長約67.2km・57駅)が基幹交通網で、ブルーラインは HITECシティ・Gachibowli方面をカバーする。Uber・Olaなどアプリ配車も広く普及している。",
        directFlightFromJapan: "ハイデラバードと日本を結ぶ直行便は現在なく、デリー・ムンバイ・ベンガルールなどで乗り継ぐか、香港・バンコクなど経由地を挟むルートが一般的。",
        commuteNote: "TomTomトラフィック指数2025によれば、ハイデラバードは世界47位(アジア15位)の渋滞都市で、通勤者はラッシュ時平均時速16.1km/hの渋滞により年間約123時間を失う計算となる。",
      },
      japaneseCommunity: {
        schools: [],
        groceries: [],
        corporateNote: "大日本印刷(DNP)は2026年4月、インド工科大学ハイデラバード校(IITH)構内の企業連携拠点「テクノロジーリサーチパーク」に海外2カ所目の研究開発拠点を開設し、EV向け無線給電技術と医薬品原薬の合成ルート開発でIITHと共同研究を進める。製薬分野では武田薬品工業がハイデラバード地盤のBiological E社と提携し、デング熱ワクチン(TAK-003)の技術移管・増産を進めている。JETRO単独のハイデラバード事務所は確認できず、NTT DATAやFujitsuはマドハプル/HITECシティ周辺にオフィスを構える。",
      },
      verifiedAt: "2026-07",
    },
  },
  {
    ...
    living: {
      housing: {
        areas: ["Bodakdev", "Satellite", "Prahladnagar"],
        rents: [
          {
            layout: "2BHK(Bodakdev、駐在員向け)",
            minUsd: 210,
            maxUsd: 370,
          },
          {
            layout: "2BHK(Satellite／Prahladnagar、駐在員向け)",
            minUsd: 210,
            maxUsd: 470,
          },
        ],
        note: "Bodakdev・Satellite・PrahladnagarはいずれもSGハイウェイ沿いのオフィス・商業集積エリアで、空港から車で15〜30分程度と近い。学齢期の子どもがいる場合、市内に日本人学校はなくMahatma Gandhi International School(MGIS)などIB系インターナショナルスクールに通うのが一般的。",
      },
      safetyHealth: {
        safetyNote: "グジャラート州は全域で禁酒法(ボンベイ禁酒法)を施行する数少ない「ドライステート」だが、外国人旅行者・NRIは州公式ポータル(eps.gujarat.gov.in)からオンラインでリカーパーミットを無料申請でき、7日間有効(最大3回まで延長し通算28日まで)で合法的に飲酒・購入ができる。パーミットなしの飲酒・所持は摘発対象となるため要注意。治安面ではNumbeoの犯罪指数(2025年時点)でアフマダーバードはデリーなど他の大都市より相対的に安定しているとされるが、混雑した市場や夜間の一人歩きには基本的な注意が必要。",
        hospitals: [
          {
            name: "Apollo Hospitals International Ltd, Ahmedabad(GIDCバット、ガンディーナガル〜アフマダーバード道路沿い)",
            note: "2003年開設、289床(ICU87床)。JCI・NABL認定。",
          },
          {
            name: "Marengo CIMS Hospital(旧CIMS Hospital、ソラ地区)",
            note: "JCI・NABH・NABL認定のマルチスペシャリティ病院。「グリーンホスピタル」を掲げ、East/West/Northの3棟で構成される。",
          },
          {
            name: "Zydus Hospital(市内旗艦拠点)",
            note: "550床、2016年9月にNABH認定取得。ビザ手続き・FRRO対応・空港送迎を含む外国人患者向けパッケージを提供する。",
          },
        ],
        healthNote: "いずれの病院も日本語対応スタッフが常駐しているとの確証は得られなかった。英語での症状説明に不安がある場合は、海外旅行保険の医療アシスタンスサービス経由で通訳付き受診を手配するのが安全。",
      },
      transport: {
        fromAirport: "サルダール・ヴァッラブバーイー・パテール国際空港(SVPI)からBodakdevまで車で約15分、Satellite・Prahladnagarまで約30分。",
        inCity: "アフマダーバード・メトロは2024年12月にフェーズ1(ブルーライン21.16km・18駅、レッドライン18.87km・15駅)が開業し、2026年1月にフェーズ2(イエロー・バイオレットライン)が全通、ガンディーナガル・GIFT City方面まで含め4路線・総延長約67.6kmに拡大した。BRTS「Janmarg」(専用レーンバス)も市内を広くカバーしており、Uber・Olaのアプリ配車も普及している。",
        directFlightFromJapan: "アフマダーバード発着の日本直行便はなく、デリーやベンガルール経由でエア・インディア/JALなどに乗り継ぐのが一般的。",
        commuteNote: "自動車・二輪の集積地であるマンダル・ベチャラジ(Suzuki Motor Gujarat、Honda Motorcycle & Scooter India第4工場などが立地、いずれもアフマダーバード県内)までは市中心部から車で1.5〜2時間程度かかり、出張日程には余裕を持たせたい。",
      },
      japaneseCommunity: {
        association: "アーメダバード日本人会(amd-japan.com)。2014年11月に会員47名で発足し、隔月第3水曜開催の食事会「三水会」やフットサル・テニスなどのサークル活動、法人会員制度を通じて在留邦人・日系企業をつないでいる。",
        schools: [],
        groceries: [],
        corporateNote: "2022年5月時点でグジャラート州に進出する日系企業は約57社(アーメダバード日本人会調べ、JETROレポートに掲載)。自動車・二輪では、スズキ子会社Suzuki Motor Gujarat(ハンサルプル)とHonda Motorcycle & Scooter India第4工場(ヴィタラプル)がいずれもアフマダーバード県マンダル・ベチャラジ地区に立地する。半導体分野ではターター・エレクトロニクスが同じくアフマダーバード県内のドーレラ(市内から車で1.5〜2時間)で台湾PSMCと提携しファブを建設中で、東京エレクトロンが成膜・エッチング装置などを供給する。JETROアーメダバード事務所(2017年11月開設、Prahladnagar)がグジャラート州における日系企業支援の窓口となっている。",
      },
      verifiedAt: "2026-07",
    },
  },
  {
    ...
    living: {
      housing: {
        areas: [
          "Ballygunge・Alipore（南コルカタの伝統的高級住宅地、総領事館や外資系駐在員が多い）",
          "Salt Lake（ビドハンナゴル、計画都市・Sector VのITハブ）／New Town（ラジャルハット、新興のIT・商業回廊）",
        ],
        rents: [
          {
            layout: "2BHK（Ballygunge・Alipore、駐在員向け）",
            minUsd: 260,
            maxUsd: 470,
          },
          {
            layout: "2BHK（Salt Lake・New Town、IT回廊）",
            minUsd: 170,
            maxUsd: 295,
          },
        ],
        note: "Ballygunge・Aliporeは英領期からの邸宅街で在外公館や富裕層が集まる一方、Salt Lake・New Townは道路網の整った計画都市でIT関連の駐在員に選ばれやすい。家賃はUSD/INR≈95.5換算。",
      },
      safetyHealth: {
        safetyNote: "外務省はコルカタを含むインドの大都市エリアを危険レベル1（十分注意してください）に指定している。サダル・ストリートやニューマーケットなど観光客の集まる繁華街ではスリ・置き引きが日常的に発生しており、飲食物に薬物を混入され金品を奪われる事例も報告されている。夜間の一人歩きは避け、Uber・Olaなどアプリ配車の利用が推奨される。",
        hospitals: [
          {
            name: "Apollo Multispeciality Hospitals（カナル・サーキュラー・ロード）",
            note: "2003年開業、Apolloグループとシンガポールのパークウェイ・ヘルスの合弁で設立された総合病院。東インドで唯一JCI(国際病院評価機構)認定を取得しており、NABH認定も持つ。",
          },
          {
            name: "Rabindranath Tagore International Institute of Cardiac Sciences（RTIICS、ムクンダプル）",
            note: "2000年に100床の心臓専門病院として開業し、現在はナラヤナ・ヘルス系列の681床複合三次医療施設に拡大。2023年にJCI認定を取得(NABL認定は2006年から)し、バングラデシュ・ブータン・ネパール・ミャンマーなど周辺国からの患者を多く受け入れる。",
          },
        ],
        healthNote: "いずれの病院も日本語対応スタッフが常駐しているとの確証は得られなかった。英語での症状説明に不安がある場合は、海外旅行保険の医療アシスタンスサービス経由で通訳付き受診を手配するのが安全。",
      },
      transport: {
        fromAirport: "ネタジ・スバス・チャンドラ・ボース国際空港(CCU、ドムドム)は市中心部の北へ約17kmに位置し、車で約40分。南コルカタのBallygunge・Aliporeへは渋滞状況により45〜60分程度を見ておきたい。",
        inCity: "コルカタ・メトロは5路線(ブルー・グリーン・パープル・イエロー・オレンジ)、総延長73.42km・58駅が運行中(2026年時点)で、インド最古の地下鉄網。Uber・Olaなどアプリ配車も広く普及している。",
        directFlightFromJapan: "コルカタ発着の日本直行便はなく、バンコク・シンガポール・香港などの第三国ハブ、またはデリー・ムンバイなど国内ハブでの乗り継ぎが一般的。",
        commuteNote: "2025年9月23日未明には記録的な豪雨(市内の一部地点で数時間のうちに300mm超、ガリア・カムダハリ地区では24時間で最大332mmを記録)によりコルカタ市内が広範囲に冠水した。感電などで市内だけで9人が死亡し、バンドロニ・ジャドブプルなど南部・東部の一部地域では冠水が3日間続いた。6〜9月の本格的なモンスーン期の出張・引っ越し日程には余裕を持たせたい。",
      },
      japaneseCommunity: {
        association: "Japan Club Kolkata（在コルカタ日本人会）",
        schools: [],
        groceries: [],
        corporateNote: "コルカタは日印交流の歴史が深く、1901〜02年に岡倉天心がタゴール家(ジョラサンコ)に約9か月滞在し、ラビンドラナート・タゴールと親交を結んだ。帰国後の1903年には岡倉が門下の横山大観・菱田春草をカルカッタへ派遣し、両者がアバニンドラナート・タゴールらベンガル派の画家に日本画の没骨(ウォッシュ)技法を伝えたことでも知られる。現在はJapan Club Kolkataが在留邦人の交流拠点となっており、在コルカタ総領事公邸での餅つき会などの行事を開催している。西ベンガル州内の日系製造拠点としては、タタ・モーターズ40%／日立建機60%出資のタタ日立建設機械カラグプル工場(コルカタから西へ約120km、2009年稼働)がある。JETROの単独事務所はなく(インド国内の拠点はニューデリー・ムンバイ・ベンガルール・チェンナイ・アーメダバードの5カ所)、経済関連の相談は在コルカタ日本国総領事館が窓口となる。",
      },
      verifiedAt: "2026-07",
    },
  },
