  ...
  },
  {
    ...
    living: {
      ...
      japaneseCommunity: {
        ...
        corporateNote: "グルガオンはNCRにおけるGCC（グローバル・キャパビリティ・センター）集積の中核で、DLFサイバーシティ・ゴルフコースロード・ウドヨグ・ビハール一帯にGCCが集中する。ハリヤナ州は2025年に「Haryana GCC Policy」を打ち出し、グルガオンを技術ハブとして強化する方針を示した。日系企業についても、日本語メディアはグルガオンをインド国内で日系企業拠点が最も集積する都市の一つと紹介しており、GCC・バックオフィス機能の受け皿としての実務的な重要性が、デリー首都圏の一部でありながらこのページを独立して設ける理由となっている。",
      },
      verifiedAt: "2026-07",
    },
  },
