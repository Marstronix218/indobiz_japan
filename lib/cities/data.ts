  ...
  },
  {
    ...
    living: {
      ...
      japaneseCommunity: {
        ...
        schools: [],
        groceries: [],
        corporateNote: "2022年5月時点でグジャラート州に進出する日系企業は約57社(JETRO調べ)。自動車・二輪では、スズキ子会社Suzuki Motor Gujarat(ハンサルプル)とHonda Motorcycle & Scooter India第4工場(ヴィタラプル)がいずれもアフマダーバード県マンダル・ベチャラジ地区に立地する。半導体分野ではターター・エレクトロニクスが同じくアフマダーバード県内のドーレラ(市内から車で1.5〜2時間)で台湾PSMCと提携しファブを建設中で、東京エレクトロンが成膜・エッチング装置などを供給する。JETROアーメダバード事務所(2013年開設、Prahladnagar)がグジャラート州における日系企業支援の窓口となっている。",
      },
      verifiedAt: "2026-07",
    },
  },
